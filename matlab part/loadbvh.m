...
while ~strcmp( C{ii} , 'MOTION' )
  ...
  elseif strcmp( token , 'OFFSET' )
    ...
    skeleton(nn).offset = [str2double(C(ii+1)) ; str2double(C(ii+2)) ; str2double(C(ii+3))];%scaling % initially 2
    ii = ii+3;
  ...
  elseif strcmp( token , 'JOINT' ) || strcmp( token , 'ROOT' )
    ...
    skeleton(nn).name = C{ii+1};
                       ...
                       %       skeleton(nn-1).offset = [3.5 0 0 ; 0 3.5 0 ; 0 0 3.5]*skeleton(nn-1).offset; 
                          ...
                          %  skeleton(nn-1).offset = 3*[1 0 0 ; 0 1 0 ; 0 0 1]*skeleton(nn-1).offset; 
  ...
  elseif strcmp( [C{ii},' ',C{ii+1}] , 'End Site' )
    ...
    skeleton(nn).name = ' ';
    skeleton(nn).offset = [2*str2double(C(ii+4)) ; 2*str2double(C(ii+5)) ; 2*str2double(C(ii+6))];
