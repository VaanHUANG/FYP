...
%
%
function count_length  = angle_find_function_4_3debug(all_angle)
global all_pt;
...
for i = 1:1
        ...
        ppp1=AxelRot((all_angle(i,1))/ pi * 180, uninormp, p22);
        pt1pii = ppp1*[p11;1];
    
        % now rotate first joint (controlling p2-p1)
        xformPts = [ pt1pii(1:3) p22 p33];
     
        ppp1=AxelRot(all_angle(i,2) / pi * 180, uninormp, p33);
